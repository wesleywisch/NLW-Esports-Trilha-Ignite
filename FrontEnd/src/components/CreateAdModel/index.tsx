...
export function CreateAdModal() {
  ...
  async function handleCreateAd(e: FormEvent) {
    ...
    const data = Object.fromEntries(formData) as CreateNewAdProps;
    ...
    if (
      ...
      try {
        await axios.post(`${import.meta.env.VITE_BACKEND_URL}/games/${data.game}/ads`, {
          name: data.name,
        ...
        <form onSubmit={handleCreateAd} className='mt-8 flex flex-col gap-4'>
          <div className='flex flex-col gap-2'>
            ...
            >
              ...
              {games.map((game, key) => (
                <option key={key} value={game.id}>{game.title}</option>
              ))}
            </select>
          </div>
